...
const HI: Dict = {
  ...
  "Retake with the lot’s feedstock": "लॉट वाला कच्चा माल चुनकर नई फ़ोटो लें",
  "This photo has already been sent. Take a new one.": "यह फ़ोटो पहले ही भेजी जा चुकी है। नई फ़ोटो लें।",
...
const PA: Dict = {
  ...
  "Retake with the lot’s feedstock": "ਲਾਟ ਵਾਲਾ ਕੱਚਾ ਮਾਲ ਚੁਣ ਕੇ ਨਵੀਂ ਫ਼ੋਟੋ ਲਵੋ",
  "This photo has already been sent. Take a new one.": "ਇਹ ਫ਼ੋਟੋ ਪਹਿਲਾਂ ਹੀ ਭੇਜੀ ਜਾ ਚੁੱਕੀ ਹੈ। ਨਵੀਂ ਫ਼ੋਟੋ ਲਵੋ।",
...
const GU: Dict = {
  ...
  "Retake with the lot’s feedstock": "લોટનો કાચો માલ પસંદ કરીને નવો ફોટો લો",
  "This photo has already been sent. Take a new one.": "આ ફોટો પહેલેથી જ મોકલાઈ ગયો છે. નવો ફોટો લો.",
